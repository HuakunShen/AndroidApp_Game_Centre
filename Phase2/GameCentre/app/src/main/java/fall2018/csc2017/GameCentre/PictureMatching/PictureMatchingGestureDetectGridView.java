...
public class PictureMatchingGestureDetectGridView extends GridView {
    ...
    public PictureMatchingGestureDetectGridView(Context context) {
        super(context);
        init(context);
    }

    public PictureMatchingGestureDetectGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PictureMatchingGestureDetectGridView(Context context, AttributeSet attrs, int defStyleAttr) {
